      ...
      <main>
        ...
        <div className='main'>
          ...
          <form>
            ...
            <br/>
            <input type='text' name='input' value={inputbox} placeholder='Type Name Here !' onChange={ (e) => setInputbox(e.target.value) }/>
            <br/>
            <p className='eg'>(Enter Pokemon names like pikachu, ditto, squirtle,etc...)</p>
            
            <button type='submit'  onSubmit={apidata}>Gotta Catch'em All...<i className='fa fa-search'></i></button>
